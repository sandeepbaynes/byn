...
*Field note · coverage: v0.7.1 · updated with each release*
...
leak happens, what byn does about it **today (v0.7.1)**, where byn
...
- **Now (opt-in) + coming:** privilege separation — opt-in since v0.3.0
  ...
  macOS, `/proc/<pid>/environ` on Linux). **v0.7.1** spawns that child in your
...
## The honest summary: unprovisioned vs provisioned

| Vector | v0.7.1 (unprovisioned) | v0.7.1 provisioned (`sudo byn setup`) | Planned |
|---|---|---|---|
