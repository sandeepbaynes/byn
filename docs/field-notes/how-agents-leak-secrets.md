...
leak happens, what byn does about it **today (v0.6.2)**, where byn
...
- **Now (opt-in) + coming:** privilege separation — opt-in since v0.3.0
  ...
  macOS, `/proc/<pid>/environ` on Linux). **v0.6.2** spawns that child in your
...
| Vector | v0.6.2 (unprovisioned) | v0.6.2 provisioned (`sudo byn setup`) | Planned |
|---|---|---|---|
