...
leak happens, what byn does about it **today (v0.4.1)**, where byn
...
- **Now (opt-in) + coming:** privilege separation — opt-in since v0.3.0
  ...
  macOS, `/proc/<pid>/environ` on Linux). **v0.4.1** spawns that child in your
...
| Vector | v0.4.1 (default) | v0.4.1 + privsep (opt-in) | Planned |
|---|---|---|---|
