...
| `daemon.fda` | macOS with privsep only: Full Disk Access. Fails when macOS (TCC) is refusing the daemon a `.byn` you have trusted. `sudo byn doctor --repair` walks you to the switch — see [troubleshooting](troubleshooting.md) |
